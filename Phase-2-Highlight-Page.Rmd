...
We then used our model to predict prices of vehicles and compared those prices to the actual testing prices in order to assess the accuracy of the model.
