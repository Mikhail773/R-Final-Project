...
![](https://media.discordapp.net/attachments/821152215866933259/838154444000591872/plotmodel_DT_TrainfinalModelText4k.png){width="683" height="493"}
...
![](https://cdn.discordapp.com/attachments/821152215866933259/838919468587286588/unknown.png)
...
![](https://media.discordapp.net/attachments/821152215866933259/838919870908989480/unknown.png)
...
![](https://media.discordapp.net/attachments/821152215866933259/839497051728511006/model_knn_428_332.png)
...
![](https://media.discordapp.net/attachments/821152215866933259/838925691906424832/unknown.png)

```{r eval=FALSE, include=TRUE}
# Compute the prediction error RMSE RMSE(knn_predictions,test.data$price_usd)
```

![](https://media.discordapp.net/attachments/821152215866933259/838925915769405460/unknown.png)
...
![](https://media.discordapp.net/attachments/821152215866933259/838926058740252672/unknown.png)
