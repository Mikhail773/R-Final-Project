...
```{r NumPhotos/Up Counter/Duration, fig.height = 10, fig.width = 10}
...
```{r KNNTune, eval=FALSE, include=TRUE}
...
```{r KNNPredictions, eval=FALSE, include=TRUE}
# Make predictions on the test data
...
```{r KNNAccuracy, eval=FALSE, include=TRUE}
