...
In an attempt to gain a robust knowledge of our dataset several visualitions were used. Visualization of our data was done in two sections. Initially each attribute was graphed in order to gain a general understanding of how the samples are distributed for each atribute. This was done with the help of Bar Graphs, Histograms, Boxplots, and the count function.
