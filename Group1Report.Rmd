...
To answer this question, we decided to firstuse a bar chart to see the average prices per region in comparison with each other.
...
The VIF tells us that there is not significant multi-collinearity between any of the continious attributes.
...
We have thoroughly and exhaustively analyzed our data set with the tools that R provides that we have learned to use through our Data Analytics course. We can conclude that the asking price of a vehicle depends on many variables and not just one. There are several correlations and trends that we have been able to identify yet without additional data for uncommon vehicles we are unable to test them fully. More testing is needed to delve further into our questions as we find answers, we find new questions to ask, and that is the core of what data science is.
