...
Minsk accounts for a very large amount of vehicles (makes sense considering the population sizes) with even distributions everywhere else. The usefulness of the attribute may be less since Minsk is such a large portion of the data.
...
The quantity of samples make this graph hard to dissect. One would have to perform tests to see how body type relates to price.
...
This graph tells us that certain body types tend to come with engines for specific fuels. That being said the range for prices seem to be very scattered.
