...
The Decision Tree had an overall accuracy of around 69.4%. Meaning that the explanatory power is equal to 69.4%.

![](images/DTCMExplorative.PNG)

The Accuracy for when we Compute ROC
...
#### Exploring Exchangeability using Logistic Regression

```{r LRExploratoryRegressionExchangeability, eval=FALSE, include=TRUE}
