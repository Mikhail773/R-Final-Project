...
The AUC, accuracy, sensitivity, and specificity are higher in the decision tree. All of these values provide a better prediction when higher. Thus the decision tree is a better prediction.
