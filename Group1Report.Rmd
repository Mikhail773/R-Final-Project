...
The VIF tells us vital information:

Since transmission color, odometer_value, year_produced, engine_fuel, engine_capacity have VIF less than 5 we can conclude that there is no significant multi-collinearity for these attributes.

However, body_type and drivetrain had VIF over 5 and less than 10 which tells us some multi-collinearity may exist for these attributes.

Lastly, Manufacturer_name had a VIF of 15 which tells us there is significant multi-collinearity. This should be noted as a possible reason for flaws in the model.
...
| Machine-Learning Methods                     |     RMSE     |  Error Rate  |      R-Square |
|:---------------------------------------------|:------------:|:------------:|--------------:|
| Multiple Linear Regression (w/o Model_Names) | **3542.066** | **53.13197** | **0.7058649** |
| SVR Linear                                   | **3257.887** | **48.86921** | **0.7772176** |
| SVR Radial                                   | **4752.231** | **71.28478** | **0.5937837** |
| Decision Tree Regression                     | **3245.413** | **48.68209** | **0.7529956** |
| Random Forest Tree Regression                | **1879.884** | **28.19878** | **0.9184761** |
