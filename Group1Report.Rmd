...
**OUR FINDINGS:**
What we have found is that the Random forest tree had the best R2 value and error rate, meaning it had the best predictions. The two worst prediction models were the Multiple Linear Regression, and SVR Radial. Here is the list of of all of our results from each of our models. The lower the error rate the better, and the higher the R2 value the better the corrolation the model has with the data.
