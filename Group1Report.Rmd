...
Lastly we have the results from the exchangeability predictive models. We had two different models to test the vehicle exchangeability, these two models are the decision tree and logistic regression. Both of these trees were very similar, however the decision tree was slightly better in predicting exchangeability.
